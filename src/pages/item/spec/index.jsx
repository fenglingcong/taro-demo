          ...
          <View key={group.id} className='item-spec__group'>
            ...
            <View className='item-spec__group-list'>
              {group.skuSpecValueList.map(item => (
                <Text
                  key={item.id}
                  className={classNames('item-spec__group-list-item', {'item-spec__group-list-item--active': this.isSelected(item, group.id), 'item-spec__group-list-item--disabled': !this.isValid(item)})}
